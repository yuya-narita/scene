(function(global){
  ...
  const M = {
    ja: {
      ...
      'field.author':'作者名','common.optional':'任意','field.author.ph':'例：あ箱 花子',
      ...
      'file.open':'作品を開く','file.export':'作品を書き出す','file.exportDistribution':'配布版を書き出す','file.exportDistribution.note':'Distribution .scene','draft.manager':'制作中一覧','draft.new':'＋ 新しく作る','draft.new.note':'新しい下書き','draft.saved':'自動保存済み','draft.full':'下書きが10件あります',
    ...
    en: {
      ...
      'field.author':'Author','common.optional':'Optional','field.author.ph':'e.g. Hanako Ahako',
      ...
      'file.open':'Open Work','file.export':'Export Work','file.exportDistribution':'Export Distribution','file.exportDistribution.note':'Distribution .scene','draft.manager':'Works','draft.new':'+ New Work','draft.new.note':'New draft','draft.saved':'Autosaved','draft.full':'You already have 10 drafts',
