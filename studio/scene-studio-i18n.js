(function(global){
  ...
  const M = {
    ja: {
      ...
      'publish.action':'公開する','publish.update':'変更を公開','publish.published':'公開中','publish.ready':'この作品を公開しますか？','publish.readyText':'公開すると、読者へ渡せるURLを発行します。','publish.updateReady':'公開中の作品を更新しますか？','publish.updateText':'変更内容を、現在の公開URLへ反映します。','publish.working':'公開しています…','publish.workingText':'作品を公開できる状態にしています。','publish.success':'公開しました','publish.share':'シェア','publish.copy':'リンクをコピー','publish.mockNote':'Hosting接続済みです。現在のURLは公開データ確認用で、読者用Playerは次の接続段階です。','publish.failed':'公開できませんでした','publish.failedText':'時間をおいて、もう一度試してください。','publish.retry':'もう一度試す',
