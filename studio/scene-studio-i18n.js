(function(global){
  ...
  const M = {
    ja: {
      'work.authorHistory':'この端末で以前使った作者名を候補に表示します。','ending.heading':'読了ページ','ending.note':'最後の余韻と、その後の導線を設定します。入力内容は下のプレビューへ即時反映されます。','ending.label.ph':'例：つづく','ending.preview.default':'読了','cover.preview.untitled':'Untitled',
      'intro.title':'文章を貼るだけ。',
    ...
    en: {
      'work.authorHistory':'Previously used author names on this device appear as suggestions.','ending.heading':'Ending page','ending.note':'Set the final afterglow and what readers can do next. Changes appear in the preview immediately.','ending.label.ph':'e.g. To be continued','ending.preview.default':'Finished','cover.preview.untitled':'Untitled',
