(function(global){
  ...
  const M = {
    ja: {
      ...
      'field.author':'作者名','common.optional':'任意','field.author.ph':'例：ペンネーム',
      ...
      'scene.view':'表示モード','scene.view.world':'通常','scene.view.console':'コンソール','scene.view.system':'システム','scene.view.warning':'警告','scene.view.void':'虚無','scene.entryMotion':'位置の動き','scene.entry.flow':'流れて着地','scene.entry.still':'その場',
      'scene.effect':'出かた','effect.auto':'おまかせ','effect.fade':'フェード','effect.pop':'ポンと出る','effect.blur':'ぼやけて現れる',
      'effect.whisper':'そっと現れる','effect.loud':'強く出る','effect.pulse':'脈打つ','effect.shake':'揺れる','effect.tilt':'傾く','effect.slow':'ゆっくり','effect.slam':'叩きつける','effect.burst':'弾ける','effect.glitchHit':'グリッチヒット（左）','effect.glitchHitRight':'グリッチヒット（右）','effect.rush':'突っ込む','effect.none':'演出なし',
      ...
      'cover.label':'表紙','cover.tapEdit':'タップして編集','cover.start':'はじめる','ending.center':'中央の文','ending.leftButton':'左ボタン','ending.rightButton':'右ボタン','ending.smallText':'小さい文字','ending.buttonLabel':'ボタン名','ending.link':'リンク','ending.clearButton':'このボタンを空にする','ending.recent':'最近使ったもの','ending.savedDevice':'この端末に保存','common.done':'完了','common.cancel':'キャンセル','common.save':'保存','common.resetCenter':'中央に戻す','cover.edit':'表紙を編集','cover.position':'表示位置','cover.positionHelp':'画像をドラッグして、見せたい位置を合わせます','cover.logoChoose':'作品ロゴ（透過PNG）を選ぶ / 変更','cover.logoRemove':'作品ロゴを外す','cover.imageChooseChange':'表紙画像を選ぶ / 変更','cover.positionAdjust':'表示位置を調整','cover.imageRemove':'表紙画像を外す','cover.liveNote':'入力は表紙プレビューへ即時反映されます。','cover.showInfo':'表紙に表示する情報','cover.show':'表紙に表示','cover.font':'表紙の書体','publish.rights':'この作品を公開するために必要な権利を有している、または権利者から必要な許可を得ています。','detail.text':'文字の詳細設定','detail.effect':'演出の詳細設定','detail.background':'背景の詳細設定','detail.audio':'音の詳細設定','toolbox.sceneOps':'Scene操作','toolbox.other':'作品全体・その他','toolbox.readerNav':'読者ナビゲーション','toolbox.editEnding':'読了ページを編集','toolbox.editWorkInfo':'作品情報・表紙を編集','toolbox.workInfo':'作品情報・表紙','common.basic':'基本','common.layout':'レイアウト','common.timing':'タイミング','common.previewSection':'プレビュー','common.playback':'再生','common.volumeFade':'音量・フェード','background.brightnessTexture':'明るさ・質感','background.sceneTransition':'Scene切替','background.motionSection':'背景の動き','audio.continuePrevious':'前Sceneを継続','audio.hasSource':'音源あり','audio.changeFile':'ファイルを変更','audio.chooseFile':'ファイルを選択','audio.ambientSeDetail':'Ambient / SE は詳細設定','scene.moveUp':'↑ 上へ移動','scene.moveDown':'↓ 下へ移動','scene.duplicate':'複製','nav.previous.shortNote':'公開Playerの戻る操作を許可','toolbox.open':'開く',
    ...
    en: {
      ...
      'field.author':'Author','common.optional':'Optional','field.author.ph':'e.g. Pen name',
      ...
      'scene.view':'View mode','scene.view.world':'Normal','scene.view.console':'Console','scene.view.system':'System','scene.view.warning':'Warning','scene.view.void':'Void','scene.entryMotion':'Position motion','scene.entry.flow':'Flow & land','scene.entry.still':'In place',
      'scene.effect':'Entrance','effect.auto':'Automatic','effect.fade':'Fade','effect.pop':'Pop in','effect.blur':'Blur in',
      'effect.whisper':'Whisper in','effect.loud':'Strong entrance','effect.pulse':'Pulse','effect.shake':'Shake','effect.tilt':'Tilt','effect.slow':'Slow','effect.slam':'Slam','effect.burst':'Burst','effect.glitchHit':'Glitch hit (left)','effect.glitchHitRight':'Glitch hit (right)','effect.rush':'Rush','effect.none':'No effect',
      ...
      'file.open':'Open Work','file.export':'Export Work','file.exportDistribution':'Export Distribution','file.exportDistribution.note':'Distribution .scene','draft.manager':'Works','draft.new':'+ New Work','draft.new.note':'New draft','draft.saved':'Autosaved','draft.full':'This device is running out of storage',
      'work.info':'Work Info & Cover','work.subtitle':'Subtitle','work.language':'Language','work.series':'Series','work.episode':'Episode label','work.cover':'Cover image','work.cover.choose':'Choose cover image','work.cover.remove':'Remove cover image','work.cover.empty':'No image is fine','work.cover.note':'Easy only sets the image. Use Advanced for detailed cover editing.','work.cover.saveNote':'The image is saved centered with cover fit. Titles and other metadata are stored separately.','work.developer':'Developer','work.subtitle.ph':'e.g. If Cooling Wins','work.series.ph':'e.g. Shino with the Poor Glasses','work.episode.ph':'e.g. Episode 01 / PROLOGUE','work.language.auto':'Automatic','work.language.ja':'Japanese','work.language.en':'English','work.language.mul':'Multiple languages','common.optional.free':'Optional · free text','common.open':'Open','draft.footer':'Draft count is unlimited and autosaved on this device. Studio warns when storage runs low.','common.close':'Close','scene.effectOnly':'Effects only','scene.empty':'Empty Scene','background.changeOverlay':'Change background from this Scene',
      ...
      'cover.label':'Cover','cover.tapEdit':'Tap to edit','cover.start':'Start','ending.center':'Center text','ending.leftButton':'Left button','ending.rightButton':'Right button','ending.smallText':'Small text','ending.buttonLabel':'Button label','ending.link':'Link','ending.clearButton':'Clear this button','ending.recent':'Recently used','ending.savedDevice':'Saved on this device','common.done':'Done','common.cancel':'Cancel','common.save':'Save','common.resetCenter':'Reset to center','cover.edit':'Edit cover','cover.position':'Position','cover.positionHelp':'Drag the image to choose what stays visible','cover.logoChoose':'Choose / change logo (transparent PNG)','cover.logoRemove':'Remove logo','cover.imageChooseChange':'Choose / change cover image','cover.positionAdjust':'Adjust position','cover.imageRemove':'Remove cover image','cover.liveNote':'Changes appear in the cover preview immediately.','cover.showInfo':'Show on cover','cover.show':'Show on cover','cover.font':'Cover typeface','publish.rights':'I own the rights required to publish this work, or have obtained the necessary permission.','detail.text':'Text details','detail.effect':'Effect details','detail.background':'Background details','detail.audio':'Audio details','toolbox.sceneOps':'Scene actions','toolbox.other':'Work-wide & other','toolbox.readerNav':'Reader navigation','toolbox.editEnding':'Edit ending page','toolbox.editWorkInfo':'Edit work info & cover','toolbox.workInfo':'Work info & cover','common.basic':'Basic','common.layout':'Layout','common.timing':'Timing','common.previewSection':'Preview','common.playback':'Playback','common.volumeFade':'Volume & fade','background.brightnessTexture':'Brightness & texture','background.sceneTransition':'Scene transition','background.motionSection':'Background motion','audio.continuePrevious':'Continue previous Scene','audio.hasSource':'Audio selected','audio.changeFile':'Change file','audio.chooseFile':'Choose file','audio.ambientSeDetail':'Ambient / SE in Audio details','scene.moveUp':'↑ Move up','scene.moveDown':'↓ Move down','scene.duplicate':'Duplicate','nav.previous.shortNote':'Allow back navigation in the public Player','toolbox.open':'Open',
