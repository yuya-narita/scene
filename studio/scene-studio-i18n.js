(function(global){
  ...
  const M = {
    ja: {
      ...
      'publish.action':'公開する','publish.update':'変更を公開','publish.published':'公開中','publish.ready':'この作品を公開しますか？','publish.readyText':'公開すると、読者へ渡せるURLを発行します。','publish.updateReady':'公開中の作品を更新しますか？','publish.updateText':'変更内容を、現在の公開URLへ反映します。','publish.working':'公開しています…','publish.workingText':'作品を公開できる状態にしています。','publish.success':'公開しました','publish.share':'シェア','publish.copy':'リンクをコピー','publish.failed':'公開できませんでした','publish.failedText':'時間をおいて、もう一度試してください。','publish.retry':'もう一度試す',
    ...
    en: {
      ...
      'work.info':'Work Info & Cover','work.subtitle':'Subtitle','work.language':'Language','work.series':'Series','work.episode':'Episode label','work.cover':'Cover image','work.cover.choose':'Choose cover image','work.cover.remove':'Remove cover image','work.cover.empty':'No image is fine','work.cover.note':'Easy only sets the image. Use Advanced for detailed cover editing.','work.cover.saveNote':'The image is saved centered with cover fit. Titles and other metadata are stored separately.','work.developer':'Developer','work.subtitle.ph':'e.g. If Cooling Wins','work.series.ph':'e.g. Shino with the Poor Glasses','work.episode.ph':'e.g. Episode 01 / PROLOGUE','work.language.auto':'Automatic','work.language.ja':'Japanese','work.language.en':'English','work.language.mul':'Multiple languages','common.optional.free':'Optional · free text','draft.footer':'Drafts are autosaved on this device. Published works can be shared or unpublished here.','common.close':'Close','scene.effectOnly':'Effects only','scene.empty':'Empty Scene','background.changeOverlay':'Change background from this Scene',
