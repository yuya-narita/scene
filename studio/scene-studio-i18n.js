(function(global){
  ...
  const M = {
    ja: {
      ...
      'publish.action':'公開する','publish.update':'変更を公開','publish.published':'公開中','publish.ready':'この作品を公開しますか？','publish.readyText':'公開すると、読者へ渡せるURLを発行します。','publish.updateReady':'公開中の作品を更新しますか？','publish.updateText':'変更内容を、現在の公開URLへ反映します。','publish.working':'公開しています…','publish.workingText':'作品を公開できる状態にしています。','publish.success':'公開しました','publish.share':'シェア','publish.copy':'リンクをコピー','publish.mockNote':'現在は公開UIのモックです。URLはテスト用です。','publish.failed':'公開できませんでした','publish.failedText':'時間をおいて、もう一度試してください。','publish.retry':'もう一度試す',
      'draft.title':'制作途中の作品','draft.all':'全て','draft.inProgress':'途中','draft.publishedTab':'公開','draft.continue':'続きから','draft.link':'リンク','draft.unpublish':'公開停止','draft.delete':'削除','draft.status.published':'公開中','draft.status.dirty':'変更あり','draft.empty.all':'作品はありません。','draft.empty.draft':'制作途中の作品はありません。','draft.empty.published':'公開中の作品はありません。','draft.today':'今日','draft.copied':'コピー済み',
      'unpublish.title':'この作品の公開を停止しますか？','unpublish.text':'公開URLは使えなくなる想定です。制作中のデータはそのまま残ります。','unpublish.named':'「{title}」の公開URLは使えなくなる想定です。制作中のデータはそのまま残ります。','unpublish.cancel':'キャンセル','unpublish.confirm':'公開を停止',
      'delete.scene.title':'このSceneを削除しますか？','delete.scene.text':'削除後も「元に戻す」で1回だけ戻せます。','delete.scene.cancel':'キャンセル','delete.scene.confirm':'このSceneを削除','common.fileReadFailed':'ファイルを読み込めませんでした。もう一度選択してください。',
    ...
    en: {
      ...
      'work.info':'Work Info & Cover','work.subtitle':'Subtitle','work.language':'Language','work.series':'Series','work.episode':'Episode label','work.cover':'Cover image','work.cover.choose':'Choose cover image','work.cover.remove':'Remove cover image','work.cover.empty':'No image is fine','work.cover.note':'Easy only sets the image. Use Advanced for detailed cover editing.','work.cover.saveNote':'The image is saved centered with cover fit. Titles and other metadata are stored separately.','work.developer':'Developer','work.subtitle.ph':'e.g. If Cooling Wins','work.series.ph':'e.g. Shino with the Poor Glasses','work.episode.ph':'e.g. Episode 01 / PROLOGUE','work.language.auto':'Automatic','work.language.ja':'Japanese','work.language.en':'English','work.language.mul':'Multiple languages','common.optional.free':'Optional · free text','common.open':'Open','draft.footer':'Drafts are autosaved on this device. Published works can be shared or unpublished here.','common.close':'Close','scene.effectOnly':'Effects only','scene.empty':'Empty Scene','background.changeOverlay':'Change background from this Scene',
      ...
      'publish.action':'Publish','publish.update':'Publish Changes','publish.published':'Published','publish.ready':'Publish this work?','publish.readyText':'Publishing creates a URL you can share with readers.','publish.updateReady':'Update the published work?','publish.updateText':'Apply these changes to the current public URL.','publish.working':'Publishing…','publish.workingText':'Preparing your work for publication.','publish.success':'Published','publish.share':'Share','publish.copy':'Copy Link','publish.mockNote':'This is currently a publishing UI mock. The URL is for testing only.','publish.failed':'Could not publish','publish.failedText':'Please wait a moment and try again.','publish.retry':'Try Again',
      'draft.title':'Works','draft.all':'All','draft.inProgress':'Drafts','draft.publishedTab':'Published','draft.continue':'Continue','draft.link':'Link','draft.unpublish':'Unpublish','draft.delete':'Delete','draft.status.published':'Published','draft.status.dirty':'Changes','draft.empty.all':'No works yet.','draft.empty.draft':'No drafts.','draft.empty.published':'No published works.','draft.today':'Today','draft.copied':'Copied',
      'unpublish.title':'Unpublish this work?','unpublish.text':'The public URL will no longer be available. Your draft will remain saved.','unpublish.named':'The public URL for “{title}” will no longer be available. Your draft will remain saved.','unpublish.cancel':'Cancel','unpublish.confirm':'Unpublish',
      'delete.scene.title':'Delete this Scene?','delete.scene.text':'You can undo this deletion once.','delete.scene.cancel':'Cancel','delete.scene.confirm':'Delete Scene','common.fileReadFailed':'Could not read the file. Please choose it again.',
