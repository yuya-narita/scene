(function(global){
  ...
  const M = {
    ja: {
      ...
      'effect.whisper':'そっと現れる','effect.loud':'強く出る','effect.pulse':'脈打つ','effect.shake':'揺れる','effect.tilt':'傾く','effect.slow':'ゆっくり','effect.slam':'叩きつける','effect.burst':'弾ける','effect.glitchHit':'グリッチヒット','effect.rush':'突っ込む','effect.none':'演出なし',
    ...
    en: {
      ...
      'effect.whisper':'Whisper in','effect.loud':'Strong entrance','effect.pulse':'Pulse','effect.shake':'Shake','effect.tilt':'Tilt','effect.slow':'Slow','effect.slam':'Slam','effect.burst':'Burst','effect.glitchHit':'Glitch hit','effect.rush':'Rush','effect.none':'No effect',
