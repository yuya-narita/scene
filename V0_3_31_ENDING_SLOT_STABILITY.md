...
- Japanese action labels use no-wrap/keep-all rules so `表紙に戻る` no longer breaks mid-label on mobile.
- Mobile ending action text is slightly reduced to fit the fixed three-column navigation row.
